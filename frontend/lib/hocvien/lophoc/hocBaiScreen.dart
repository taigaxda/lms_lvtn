...
//     // ✅ Nếu là PDF, thử nhiều cách
//     if (extension == 'pdf') {
//       await _openPdfWithMultipleMethods(url);
//       return;
//     }
...
//   // ==================== MỞ PDF VỚI NHIỀU CÁCH ====================
//   Future<void> _openPdfWithMultipleMethods(String url) async {
//     // ✅ Cách 1: Google Docs Viewer
//     final encodedUrl = Uri.encodeComponent(url);
//     final googleDocsUrl = 'https://docs.google.com/gview?embedded=true&url=$encodedUrl';
    
//     try {
//       bool opened = await _openWithBrowser(googleDocsUrl);
//       if (opened) return;
//     } catch (e) {
//       print('Google Docs Viewer fail: $e');
//     }

//     // ✅ Cách 2: Thử với fl_attachment
//     String downloadUrl = _fixCloudinaryUrl(url);
//     try {
//       bool opened = await _openWithBrowser(downloadUrl);
//       if (opened) return;
//     } catch (e) {
//       print('fl_attachment fail: $e');
//     }

//     // ✅ Cách 3: Thử URL gốc (không fl_attachment)
//     try {
//       String originalUrl = url.replaceFirst("fl_attachment/", "");
//       bool opened = await _openWithBrowser(originalUrl);
//       if (opened) return;
//     } catch (e) {
//       print('Original URL fail: $e');
//     }
...
//     if (url.contains("upload/")) {
//       if (_isDocumentFile(extension)) {
//         // ✅ Nếu chưa có fl_attachment thì thêm vào
